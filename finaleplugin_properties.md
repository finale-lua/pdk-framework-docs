...
Setting this value to `true` causes _RGP Lua_ to load `luasocket` in the the Lua state before running the script. It overrides the **Enable Debugging** setting in the configuration dialog.
